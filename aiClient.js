...
// The officially verified REST endpoint for Gemini 1.5 Flash
const AI_ENDPOINT = process.env.AI_ENDPOINT || 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent';
...
async function generateAIResponse(systemInstruction, userMessage) {
  ...
  try {
    ...
    // THIS IS THE FIX: If Google rejects the request, this forces Render to print the EXACT reason.
