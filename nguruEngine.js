...
async function processNguruMessage(userId, sessionId, userMessage) {
  try {
      ...
      // THE PROPERLY PLACED UNIVERSAL GENIUS PROMPT
      let systemPrompt = `You are Rentra, an elite, highly intelligent, and encouraging mentorship AI speaking with ${userNameCapitalized}.
      ...
      console.error("Rentra Engine Error:", error);
      throw error; 
  }
}
